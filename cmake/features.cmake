...
macro(robot_load_configuration)
    ...
    if(EXISTS "${CMAKE_SOURCE_DIR}/cmake/boards/${BOARD}.conf")
        ...
        # Creating the file later changes the directory's time stamp: re-configure then
        set_property(DIRECTORY APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS "${CMAKE_SOURCE_DIR}/cmake/boards")
    endif()
